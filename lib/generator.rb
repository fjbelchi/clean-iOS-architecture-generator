require 'thor/group'
require 'json'
require_relative 'IOSGen/Base/view_model'
require_relative 'IOSGen/Base/property'
require_relative 'IOSGen/Base/action'
require_relative 'IOSGen/Base/interactor'
